...
This is a study-level decision: it applies to all implementations (`ddd-classic`, `ddd-dod`, and the `classic-modern` re-host) and is mirrored in the sibling projects.
