...
const type = await tp.system.prompt("Type (phase | capability | refactor | infra)");
...
<!--
Type semantics:
- phase     — temporally ordered milestone (e.g. "bootstrap", "MVP", "v1").
...
<!--
Formal "done" criteria for this epic. When all checked → status: done →
release candidate (see playbook.md §16.4). Each item should be testable
or observable.
-->
