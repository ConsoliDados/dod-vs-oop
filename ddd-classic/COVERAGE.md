...
Following the sad-paths audit (see `docs/ddd-classic/architecture/error-contracts.md`), we added **57 new test cases** targeted at the branches that the SRS's happy-path bias was leaving uncovered:
