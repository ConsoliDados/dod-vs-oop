...
import { LOGGER } from '../../../../shared/infrastructure/logger/logger.provider'
...
export const onTransactionPostedHandlerProvider: Provider = {
  ...
  inject: [GET_ACCOUNT_REPOSITORY, UPDATE_ACCOUNT_REPOSITORY, LOGGER],
  useFactory: (
    getAccount: GetAccountRepository,
    updateAccount: UpdateAccountRepository,
    logger: Logger,
  ) => new OnTransactionPostedHandler(getAccount, updateAccount, logger),
}
