...
docs/dod-vs-oop-classic/           # Obsidian vault (medium tier, Mode B)
...
| Aspect | `ddd-templates` (original) | `dod-vs-oop-classic` (this project) |
|---|---|---|
...
Full details in [`docs/dod-vs-oop-classic/architecture/playbook/playbook.md`](./docs/dod-vs-oop-classic/architecture/playbook/playbook.md).
...
- [x] `project_templates` applied: AGENTS.md + CLAUDE.md at root, `docs/dod-vs-oop-classic/` with Obsidian vault, single playbook replacing the template's base+ts, CI workflow, methodology.md, epics/sprints/backlogs/roadmap, ADRs/SDDs scaffolds
...
- [ ] Conformance suite vs `dod-vs-oop-dod`

## Entry points

1. `AGENTS.md` (root) — declarations + project-specific overrides (tier, mode, errors, contexts, scripts)
2. [`docs/dod-vs-oop-classic/methodology.md`](./docs/dod-vs-oop-classic/methodology.md) — operating guide (narrative): Day 1 onboarding, lifecycle, recipes
3. [`docs/dod-vs-oop-classic/architecture/playbook/playbook.md`](./docs/dod-vs-oop-classic/architecture/playbook/playbook.md) — single project playbook (replaces base+ts from the template — verbose-canonical throw-based OOP)
4. [`docs/dod-vs-oop-classic/architecture/sad.md`](./docs/dod-vs-oop-classic/architecture/sad.md) / [`srs.md`](./docs/dod-vs-oop-classic/architecture/srs.md) — architecture and requirements
5. [`docs/dod-vs-oop-classic/epics/`](./docs/dod-vs-oop-classic/epics/) — active epic + `exits_with` + Mode B features
